...
// in core/test/presentation/bloc/detail_bloc_test.dart.
...
import 'package:core/domain/usecases/get_movie_detail.dart' as _i5;
import 'package:core/domain/usecases/get_tv_detail.dart' as _i9;
...
class MockGetTvDetail extends _i1.Mock implements _i9.GetTvDetail {
  ...
  @override
  _i6.Future<_i3.Either<_i7.Failure, _i10.TvDetail>> execute(int? id) =>
      (super.noSuchMethod(Invocation.method(#execute, [id]),
              returnValue: Future<_i3.Either<_i7.Failure, _i10.TvDetail>>.value(
                  _FakeEither_1<_i7.Failure, _i10.TvDetail>()))
          as _i6.Future<_i3.Either<_i7.Failure, _i10.TvDetail>>);
}
